...
\item
  ...
  process where the topics are intermediaries used to generate some other goal\footnote{amrith: apper)

\item
Its conclusions are based on a finite number of data sets and it is possible
...
other researchers to repeat/ refute/ improve their conclusions.
  \ei
Our first threat to validity for these conclusions
